...
```
[slack.gimme.tools/channels/C123/messages/M456](http://slack.gimme.tools/channels/C123/messages/M456)
      ↑
...
```bash
[gdrive.gimme.tools/files/abc123](http://gdrive.gimme.tools/files/abc123)        ← native format
[gdrive.gimme.tools/files/abc123.json](http://gdrive.gimme.tools/files/abc123.json)   ← metadata as JSON
[gdrive.gimme.tools/files/abc123.md](http://gdrive.gimme.tools/files/abc123.md)     ← content as Markdown
[gdrive.gimme.tools/files/abc123.pdf](http://gdrive.gimme.tools/files/abc123.pdf)    ← content as PDF
```
...
GET [notion.gimme.tools/pages/xyz789](http://notion.gimme.tools/pages/xyz789)         ← native Notion format
GET [notion.gimme.tools/pages/xyz789.md](http://notion.gimme.tools/pages/xyz789.md)      ← as Markdown
GET [notion.gimme.tools/pages/xyz789.html](http://notion.gimme.tools/pages/xyz789.html)    ← as HTML
GET [notion.gimme.tools/pages/xyz789.json](http://notion.gimme.tools/pages/xyz789.json)    ← metadata only

# Get Google Drive file in different formats
GET [gdrive.gimme.tools/files/abc123](http://gdrive.gimme.tools/files/abc123)         ← native format
GET [gdrive.gimme.tools/files/abc123.pdf](http://gdrive.gimme.tools/files/abc123.pdf)     ← export as PDF
GET [gdrive.gimme.tools/files/abc123.txt](http://gdrive.gimme.tools/files/abc123.txt)     ← extract plain text
```
...
GET [slack.gimme.tools/channels](http://slack.gimme.tools/channels)                           ← list channels
GET [slack.gimme.tools/channels/C123](http://slack.gimme.tools/channels/C123)                      ← channel info
GET [slack.gimme.tools/channels/C123/messages](http://slack.gimme.tools/channels/C123/messages)             ← messages in channel
GET [slack.gimme.tools/channels/C123/messages/M456](http://slack.gimme.tools/channels/C123/messages/M456)        ← specific message
GET [slack.gimme.tools/channels/C123/messages/M456/threads](http://slack.gimme.tools/channels/C123/messages/M456/threads) ← thread replies
```
...
GET [gdrive.gimme.tools/files/spreadsheet123.csv](http://gdrive.gimme.tools/files/spreadsheet123.csv)

# Get PDF export of a doc
GET [gdrive.gimme.tools/files/doc456.pdf](http://gdrive.gimme.tools/files/doc456.pdf)

# Get rendered HTML
GET [notion.gimme.tools/pages/xyz789.html](http://notion.gimme.tools/pages/xyz789.html)
```

The format suffix tells the server **how** to return the content, leveraging each provider's native export capabilities.

Organizes resources into standard collections (channels, files, pages, issues) with format suffixes (.json, .md, .pdf) for content negotiation. Each provider defines its own collection hierarchy.