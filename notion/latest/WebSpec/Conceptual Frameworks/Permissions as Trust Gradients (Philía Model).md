# Permissions as Trust Gradients (Philía Model)
...
| --- | --- | --- |
| **Owner (u)** | **Philautia** (φιλαυτία) | Self-relationship; what you permit yourself |
| **Group (g)** | **Philia** (φιλία) | Chosen friendship; mutual trust with selected circle |
| **Other (o)** | **Agape** (ἀγάπη) | Universal love; what you offer freely to all |
...
| **Storge** (στοργή) | Familial love | Inherited group membership | Organization/team scopes |
| **Philia** | Friendship | `g+rw` | Explicitly granted service access |
| **Eros** (ἔρως) | Intimate love | `g+rwx, o-rwx` | Full access + exclusivity |
| **Agape** | Unconditional | `o+r` | Public read-only APIs |
| **Pragma** (πρᾶγμα) | Enduring love | Sticky bit (t), immutable | Persistent grants, saved preferences |
| **Ludus** (λοῦδος) | Playful love | Temporary/session scopes | OAuth implicit grants, short TTL |
| **Mania** (μανία) | Obsessive love | Privilege escalation | *Pathological case* |
...
Philía answer: *You don't give everyone in your life the same level of intimacy. Some people can see your thoughts (read), some can influence you (write), and very few can act on your behalf (execute). Apps are the same.*
...
The third requires the deepest trust. The Philía Model makes this viscerally clear in a way that technical documentation often fails to convey.
...
`[TODO:UX]` Prototype permission prompts using Philía language with user testing
